...
# install to /data/adb/overlay_modules directly
############################################
...
install_module() {
  ...
  [ ! -f $TMPDIR/module.prop ] && abort "module.prop not found !"
...
NVBASE=/data/adb/overlay_modules
TMPDIR=/dev/tmp
